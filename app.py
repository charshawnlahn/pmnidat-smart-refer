...
# --- 1. การตั้งค่าการเชื่อมต่อ (Stable Version 2026) ---
try:
    API_KEY = st.secrets["GEMINI_API_KEY"]
    APPS_SCRIPT_URL = st.secrets["APPS_SCRIPT_URL"]
    
    # เชื่อมต่อผ่าน SDK ตัวใหม่ google-genai
    client = genai.Client(api_key=API_KEY)
    
    # ใช้รุ่น 1.5-flash เพื่อความเสถียรสูงสุดในงานระดับโรงพยาบาล
...
# --- 3. ฟังก์ชันจัดการไฟล์ Word (ชิดขวา + ฟอนต์ 13 + มาตรฐาน PMNIDAT) ---
...
if st.button("🚀 สกัดข้อมูลและสร้างเอกสาร"):
    ...
    with st.spinner(f'กำลังประมวลผลผ่าน {MODEL_ID}...'):
        prompt = f"""
...
st.info("""
    ...
    * ระบบ PMNIDAT Smart D/C Transfer ไม่มีการจัดเก็บข้อมูลผู้ป่วยไว้ในเซิร์ฟเวอร์
