...
def load_test_data():
    ...
    st.session_state.s12 = "1. F15.5 - โรคจิตจากสารกระตุ้น (Amphetamine)\n2. I10 - โรคความดันโลหิตสูง (Hypertension)"
    ...
    # ข้อมูลจาก Step 3.3
    st.session_state.s33 = "คุณวิไล หลานวงศ์ (ภรรยา) เบอร์โทร: 081-234-XXXX"
    # ข้อมูลจาก Step 3.4
