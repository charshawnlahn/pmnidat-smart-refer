...
with st.sidebar:
    ...
    st.info("""
    1. **คลิกเมาส์ซ้ายค้าง** ที่ต้นข้อความ แล้วลากเมาส์ลงล่างไปจนสุดหน้าต่างให้ครอบข้อมูลทั้งหมด
    2. กด **Ctrl+C** (หรือคลิกขวาแล้วกดเลือก copy) เพื่อทำการคัดลอก
    3. มาที่หน้าแอพนี้ คลิกเลือกช่องที่ต้องการ แล้วกด **Ctrl+V** (หรือคลิกขวากดเลือก paste) เพื่อวางข้อมูล
    """)
