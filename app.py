...
from google import genai  # Library มาตรฐานใหม่ปี 2026
...
# --- 1. การตั้งค่าการเชื่อมต่อ (แก้ไข MODEL_ID เพื่อแก้ 404) ---
try:
    ...
    # ใช้ชื่อ ID ที่รองรับทั้ง v1 และ v1beta แน่นอนในปี 2026
...
# --- 4. การออกแบบหน้าเว็บและคู่มือแบบละเอียดสำหรับพี่พยาบาล (ฉบับเดิมเต็มรูปแบบ) ---
...
st.subheader(f"ระบบสร้างไฟล์ใบส่งต่อ 062 อัตโนมัติ (ขุมพลัง: {MODEL_ID})")
...
if st.button("🚀 สกัดข้อมูลและสร้างเอกสาร"):
    ...
    with st.spinner('AI กำลังสังเคราะห์เนื้อหาตามมาตรฐานสถาบันฯ...'):
        prompt = f"""
        ...
        """
        try:
            # เรียกใช้ด้วย Syntax ใหม่ และ MODEL_ID ที่แก้ไขแล้ว
