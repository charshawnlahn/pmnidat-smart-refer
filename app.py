...
# --- 4. การออกแบบหน้าเว็บ (คู่มือแบบละเอียดสำหรับพี่พยาบาล) ---
...
# --- 5. ส่วนประมวลผล (Advanced Extraction with Gemini 3) ---
if st.button("🚀 สกัดข้อมูลและสร้างเอกสาร"):
    all_raw = f"{s11} {s12} {s13} {s14} {s2} {s31} {s32} {s33} {s34}"
    with st.spinner('Gemini 3 Flash กำลังสังเคราะห์เนื้อหาและจัดรูปแบบ...'):
        prompt = f"""
        ...
        try:
            ...
            if match:
                ...
                st.error("AI ไม่สามารถสร้างรูปแบบข้อมูลที่ถูกต้องได้ กรุณาลองใหม่อีกครั้ง")
        except Exception as e:
