...
with st.sidebar:
    ...
    with st.expander("🟠 STEP 3: เวชระเบียน (Registration)"):
        ...
        **3.1 ทั่วไป 1:** 
        - คัดลอกชื่อ, อายุ, เลขบัตรประชาชน, ศาสนา
...
with s1_cols[2]:
    st.text_area(
        ...
        key="s13",
        help="คัดลอก Order และ Home medication ทั้งหมดที่มี"
    )
...
with s3_cols[0]:
    st.text_area(
        "3.1 ข้อมูลทั่วไป", 
        height=200,
        placeholder="ชื่อ, อายุ, เลขบัตรประชาชน ...",
        key="s31",
...
with s3_cols[2]:
    st.text_area(
        "3.3 ผู้ติดต่อ", 
        height=200, 
        placeholder="ชื่อญาติ ความสัมพันธฺ เบอร์โทรศัพท์ ...",
        key="s33",
