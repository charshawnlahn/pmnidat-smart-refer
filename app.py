...
if st.button("🚀 กดเพื่อประมวลผลและสกัดข้อมูลด้วย Gemini 3 Flash", use_container_width=True):
    ...
    with st.spinner('Gemini 3 Flash กำลังวิเคราะห์ข้อมูลเชิงลึกและตรวจสอบ Verification Audit...'):
        ...
        2. ตรรกะการสกัดข้อมูลรายกลุ่ม (Search & Extract Logic):
           - [HN/AN]: มองหาตัวเลขหลังคำว่า 'HN' หรือ 'Hospital number' หรือ 'AN' 
           - [สิทธิการรักษา]: สกัดข้อความระหว่าง 'สิทธิ์ :' ถึง '(ไม่มีหนังสือส่งตัว)' หรือข้อความถัดไป 
           ...
           - [ยา (MEDS)]: ค้นหาเฉพาะรายการยาที่มีคำว่า 'Home-Med' หรือ รายการยาที่มีปริมาณการสั่งจ่ายมากกว่าปริมาณที่กินต่อวัน สกัดชื่อยาเป็น UPPERCASE พร้อมวิธีใช้และการบริหารยา ให้เขียนต่อกันในแถวเดียวและคั่นด้วยเครื่องหมายคอมม่า (,) ไปจนครบ
           - [คะแนนประเมิน]: สกัดตัวเลขหลัง 'ผลรวมการประเมินโรคซึมเศร้า' (9Q) และ 'การฆ่าตัวตาย' (8Q) 
           - [สรุปปัญหา (PROGRESS)]: สังเคราะห์จาก Progress Note ทั้งหมดที่ได้รับ ให้เป็นสรุปย่อหน้าเดียว ความยาว 2-3 บรรทัด 
           - [ข้อมูลเวชระเบียน]: สกัดชื่อ-สกุล, อายุ, บัตรประชาชน (13 หลัก), ศาสนา, อาชีพ และที่อยู่ปัจจุบัน 
           - [หน่วยบริการใกล้บ้าน]: สกัดชื่อโรงพยาบาลหลังคำว่า 'สถานพยาบาลหลัก' 
           - [ผู้ดูแล]: สกัดชื่อผู้ติดต่อ ความสัมพันธ์ และเบอร์โทรศัพท์ 
